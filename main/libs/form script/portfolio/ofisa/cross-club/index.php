<div class="container-fluid portfolioModal" id="portfolioModal__doc">
  <div class="row">
    <div class="col-lg-6 p-0">
      <ul id="imageGallery">
        <li data-thumb="/img/portfolio/cross-club/1.jpg" data-src="/img/portfolio/cross-club/1.jpg">
          <img src="/img/portfolio/cross-club/1.jpg" class="portfolioModal__image" />
        </li>
        <li data-thumb="/img/portfolio/cross-club/2.jpg" data-src="/img/portfolio/cross-club/2.jpg">
          <img src="/img/portfolio/cross-club/2.jpg" class="portfolioModal__image" />
        </li>
        <li data-thumb="/img/portfolio/cross-club/3.jpg" data-src="/img/portfolio/cross-club/3.jpg">
          <img src="/img/portfolio/cross-club/3.jpg" class="portfolioModal__image" />
        </li>
        <li data-thumb="/img/portfolio/cross-club/4.jpg" data-src="/img/portfolio/cross-club/4.jpg">
          <img src="/img/portfolio/cross-club/4.jpg" class="portfolioModal__image"/>
        </li>
        <li data-thumb="/img/portfolio/cross-club/5.jpg" data-src="/img/portfolio/cross-club/5.jpg">
          <img src="/img/portfolio/cross-club/5.jpg" class="portfolioModal__image"/>
        </li>
      </ul>
    </div>
    <div class="col-lg-6 p-0">
      <div class="portfolioModal__block">
        <h2 class="modal-title portfolioModal__title" id="portfolioModalLongTitle">
          Проектирование офиса «Кросс клуб»
        </h2>
