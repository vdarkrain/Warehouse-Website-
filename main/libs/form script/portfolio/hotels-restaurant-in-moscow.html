<div class="container-fluid portfolioModal" id="portfolioModal__doc">
  <div class="row">
    <div class="col-lg-6 p-0">
      <ul id="imageGallery">
        <li data-thumb="/img/portfolio/hotels-restaurant-in-moscow/1.jpg" data-src="/img/portfolio/hotels-restaurant-in-moscow/1.jpg">
          <img src="/img/portfolio/hotels-restaurant-in-moscow/1.jpg" class="portfolioModal__image" />
        </li>
        <li data-thumb="/img/portfolio/hotels-restaurant-in-moscow/2.jpg" data-src="/img/portfolio/hotels-restaurant-in-moscow/2.jpg">
          <img src="/img/portfolio/hotels-restaurant-in-moscow/2.jpg" class="portfolioModal__image" />
        </li>
      </ul>
    </div>
    <div class="col-lg-6 p-0">
