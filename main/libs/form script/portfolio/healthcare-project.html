<div class="container-fluid portfolioModal" id="portfolioModal__doc">
  <div class="row">
    <div class="col-lg-6 p-0">
      <ul id="imageGallery">
        <li data-thumb="/img/portfolio/healthcare-project/1.jpg" data-src="/img/portfolio/healthcare-project/1.jpg">
          <img src="/img/portfolio/healthcare-project/1.jpg" class="portfolioModal__image" />
        </li>
      </ul>
    </div>
    <div class="col-lg-6 p-0">
      <div class="portfolioModal__block">
        <h2 class="modal-title portfolioModal__title" id="portfolioModalLongTitle">
          Проект ресторана в оздоровительном комплексе
        </h2>
